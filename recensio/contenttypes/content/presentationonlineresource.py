            ...
            atapi.StringField(
                ...
                widget=atapi.LabelWidget(
                    label=_(
                        ...
                        default=(
                            u"Please use the following menu to describe the contents and "
            ...
            atapi.LinesField(
                ...
                widget=atapi.MultiSelectionWidget(
                    ...
                    description=_(
                        ...
                        default=(
                            u"Classify here (if applicable) the institution supplying the "
                            "resource"
                        ),
                    ),
                    format="checkbox",
            ...
            atapi.LinesField(
                ...
                widget=atapi.MultiSelectionWidget(
                    ...
                    description=_(
                        ...
                        default=(
                            u"Choose here (if applicable) the types of bibliographies, "
...
PresentationOnlineResourceSchema["ddcSubject"].widget.description = _(
    ...
    default=(
        u"Please classify what the online resource provides concerning "
...
PresentationOnlineResourceSchema["review"].widget.label = _(
    u"label_presentation_online_resource_review", default=(u"Description")
)
PresentationOnlineResourceSchema["review"].widget.description = _(
    u"description_presentation_online_resource_review",
    default=(
        u"What does the online resource provide? Please outline briefly "
...
PresentationOnlineResourceSchema["canonical_uri"].widget.visible = {
    "edit": "invisible",
    "view": "invisible",
}

finalize_recensio_schema(
    PresentationOnlineResourceSchema, review_type="presentation_online"
)
...
class PresentationOnlineResource(BaseReview):
    ...
    documenttypes_institution = atapi.ATFieldProperty("documenttypes_institution")
    documenttypes_cooperation = atapi.ATFieldProperty("documenttypes_cooperation")
    documenttypes_referenceworks = atapi.ATFieldProperty("documenttypes_referenceworks")
    documenttypes_bibliographical = atapi.ATFieldProperty(
        "documenttypes_bibliographical"
    )
    documenttypes_periodicals = atapi.ATFieldProperty("documenttypes_periodicals")
    documenttypes_fulltexts = atapi.ATFieldProperty("documenttypes_fulltexts")
...
class PresentationOnlineResourceNoMagic(BasePresentationNoMagic):
    def getDecoratedTitle(real_self):
        ...
        return full_citation(self.title.decode("utf-8"), rezensent_string)
