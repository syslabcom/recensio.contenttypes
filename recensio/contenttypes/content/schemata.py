        ...
        atapi.BooleanField(
            ...
            widget=atapi.BooleanWidget(
                ...
                description=_(
                    ...
                    default=(
                        u'Zeige die URL der Rezension in der "Zitierhinweis"-Box. Diese'
                        "Option kann hier nicht deaktiviert werden, wenn sie"
                        "bereits auf einer übergeordneten Ebene (Zeitschrift, Band,"
                        "Ausgabe) deaktiviert ist. Die Einstellung hat außerdem keine"
                        "Wirkung, falls ein externer Volltext für die Rezension benutzt"
                        "wird; in diesem Fall bleibt die URL immer versteckt. Beachten"
                        "Sie, dass diese Einstellung weder den eigentlichen Zitierhinweis"
                        "noch die Anzeige der Original-URL beeinflusst."
                    ),
                ),
...
ExhibitionSchema = CommonReviewSchema.copy() + atapi.Schema(
    (
        ...
        atapi.StringField(
            ...
            widget=atapi.StringWidget(label=_(u"URL der Website"),),
        ),
        atapi.StringField(
            "doi_exhibition",
            schemata="Ausstellung",
            storage=atapi.AnnotationStorage(),
            widget=atapi.StringWidget(label=_(u"DOI der Website"),),
        ),
    )
)
