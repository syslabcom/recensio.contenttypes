...
map = {
    ...
    "Add Praesentationen von Internetressourcen": (
        "Add Presentation Online Resource",
        "",
    ),
    "Add Praesentationen von Aufsatz in Zeitschrift": (
        "Add Presentation Article Review",
        "",
    ),
    ...
    for dirpath, dirnames, files in os.walk("."):
        for a_file in files:
            if a_file != __file__ and (
                a_file.endswith(".pt")
                or a_file.endswith(".xml")
                or a_file.endswith(".zcml")
                or a_file.endswith(".py")
            ):
