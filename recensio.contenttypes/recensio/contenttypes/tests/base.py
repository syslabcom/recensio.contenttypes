...
def setup_product():
    ...
    import recensio.contenttypes
    zcml.load_config('configure.zcml', recensio.contenttypes)
    ...
    ztc.installPackage('recensio.contenttypes')
...
setup_product()
ptc.setupPloneSite(products=['recensio.contenttypes'])
